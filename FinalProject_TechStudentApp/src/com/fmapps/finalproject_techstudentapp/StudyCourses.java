...
public class StudyCourses extends ListActivity {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	String [] courseListArray = {"Introduction to Computer Systems", "Problem Solving with Computer Programming (Alice)", 
			"Programming Fundamentals"};  // array that holds titles of the menu
	/* future updates:
   ...
   "Introduction to Information Systems and Technologies", "Mobile Device and Multimedia Programming"
	...
	//ListAdapter that displays Menu Items containing titles from the previous array
}

protected void onListItemClick(ListView l, View v, int position, long id){
	
	switch(position){    // depending on the rank of the menu clicked an activity will be opened
	case 0:   // Introduction to Computer Systems
	startActivity(new Intent(StudyCourses.this, CSIntroIlluminated.class));	
		break;  
	case 1:     //  Problem Solving with Computer Programming
	startActivity(new Intent(StudyCourses.this, PSAlice.class));	
		break;
	case 2:   //  Programming Fundamentals
		startActivity(new Intent(StudyCourses.this, ProgrammingFundamentals.class));	
		break;
